    ...
    */
    describe('RSS Feeds', function() {
        ...
        */
        ...
        // verify URL isnt null in allFeeds objects
        ...
        // verify name isn't null in allFeeds objects
         it('all hava a name', function(){
            for(var i = 0; i < allFeeds.length; i++){
    ...
    describe("The Menu", function(){
        ...
        it('Expands when icon is clicked', function(){
            $(".icon-list").click();
    ...
    describe("Initial Entries", function(){
        ...
        it('Has at least one entry when loadFeed is done', function(done){
    ...
    describe("New Feed Selection", function(){
        ...
        it('Changes content with different feeds', function(done){
            loadFeed(0, function(){
